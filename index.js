const resumeData = {
    ...
    education: {
        institution: "Ташкентский университет информационных технологий имени Мухаммада аль-Хоразмий",
        faculty: "факультет кибербезопасности",
        degree: "Бакалавр по направлению «Информационная безопасность» (инженер-программист), 2024 г."
    },
    experience: [
        { role: "Учитель информатики", location: "школа № 339, г. Ташкент", period: "2023 г" },
        { role: "Пресс-секретарь", location: "Ташкентский университет информационных технологий", period: "2020 г" },
        { role: "Отдел Аналитика сектор BSS", location: "Anor Bank", period: "2024" }
    ],
    skills: [
    ...
    additional: "Уверенные знания в области информационной безопасности и защиты данных. Опыт работы с техническими и исследовательскими проектами в области информационных технологий."
};
...
document.getElementById("contact").innerHTML = `<strong>Контакт:+998939114979</strong> <a href="mailto:${resumeData.contact.split(": ")[1]}">${resumeData.contact.split(": ")[1]}</a>`;
...
document.getElementById("languages").querySelector("p").textContent = resumeData.languages;
document.getElementById("additional").querySelector("p").textContent = resumeData.additional;
